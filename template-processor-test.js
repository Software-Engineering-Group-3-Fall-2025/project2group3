...
assert.strictEqual(str, 'My favorite month is July but not the day 1 or the year 2016');
...
assert.strictEqual(str, 'My favorite month is  but not the day 1 or the year 2016');
